...
// Dark Scheme (Deep Slate / Dark Mode)
val PrimaryDark = Color(0xFF60A5FA)
val OnPrimaryDark = Color(0xFF0B1B3D)
...
val BackgroundDark = Color(0xFF0B0F17) // Ultra deep slate
